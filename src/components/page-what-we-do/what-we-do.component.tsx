        ...
        return (
            <div className="main-what-we-do">
                ...
                <div className="tantum-block our-purpose">
                    ...
                    <p>You will enter a development management contract with Deane Property, which will clearly highlight the work that is being carried out, and allow Deane to manage your project from start to finish. Deane will then enter into contracts with each individual contractor, and pay for work in arrears. This ensures no large upfront payments are made, as you will have an easy to use staggered one-channel payment system through Deane. For peace of mind, all warranty and insurance, including all certifications, will be handed over to you at the end of the project.</p>
                </div>
