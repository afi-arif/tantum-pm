...
export default class Aboutus extends React.Component<ShowInfo> {
    ...
    render() {
        const visions = [
            {
                title: "Our purpose",
                info: " Deane Property was established in 2015, our founder Siraj Deane had one simple mission – to meet the demand for experienced residential project managers at home and abroad."
            },
            {
                title: "Why choose us",
