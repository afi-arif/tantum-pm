            ...
            <>
                ...
                <div className="home-page">
                    ...
                    <div className="tantum-block welcome">
                        <div className="content">
                            <h2>Welcome</h2>
                            <p>We are Deane – a residential project management company that serves a diverse clientele across the UK and beyond.</p>
                    ...
                    <div className="tantum-block what-we-do">
                        <div>
                            <h2>What we do</h2>
                            <p>Deane provides project management services for private , individual clients.We have designed it for those who wish to carry out redevelopments on their own property, or to complete a new build from scratch.</p>
                        </div>
                        <div>
                        ...
                        <div className="content">
                            ...
                            <div className="feedback">
                                ...
                                <div className="client-details">
                                    ...
                                    <span>London</span>
                                    <div className="comment">
                                        "The Deane team managed every step which allowed me to get on with my life! Very easy, stress free process. Very friendly. Will definitely use Deane again!"
                                    </div>
                                </div>
